  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      <header className={`px-8 py-4 border-b shrink-0 flex items-center justify-between transition-colors duration-500 ${
        ...
        <button className="flex items-center gap-2 px-6 py-2 bg-[#E1261C] text-white font-black text-[10px] uppercase tracking-widest rounded-xl hover:bg-[#4E342E] transition-all shadow-lg shadow-[#E1261C]/20">
      ...
      <main className={`flex-1 overflow-y-auto p-8 no-scrollbar transition-colors ${
        ...
        <div className="max-w-3xl space-y-8">
          <div className={`p-6 rounded-[2rem] border flex items-start gap-4 mb-10 transition-colors ${
            ...
            <div>
              <h4 className="text-sm font-black text-[#E1261C] uppercase tracking-widest mb-1">How rules work</h4>
            ...
            >
              <div className="flex items-center gap-6">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center transition-all ${
                  rule.active 
                    ? (isDarkMode ? 'bg-[#D4AF37]/20 text-[#D4AF37]' : 'bg-[#E1261C]/10 text-[#E1261C]') 
